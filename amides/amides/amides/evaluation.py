    ...
    def create_info_dict(self):
        ...
        info = {
            ...
            "results": {
                ...
                "top_3_hits": self._top_n_hits[:3].sum(),
                "top_3_hit_rate": self._top_n_hit_rates[:3].sum(),
                "top_5_hits": self._top_n_hits[:5].sum(),
                "top_5_hit_rate": self._top_n_hit_rates[:5].sum(),
